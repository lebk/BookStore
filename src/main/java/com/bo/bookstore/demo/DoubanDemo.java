...
public class DoubanDemo {
	...
	public static void main(String[] args) {
		...
		// String apiKey = "0808b64c7acb97e8181a22e57062c7b8";
		// String secret = "2c2d8710f9ff4f72";
	...
	private static void testSubjectEntry(DoubanService myService) {
		...
		try {
			...
			// q=null
			// SubjectFeed subjectFeed = myService.findMovie(null, "cowboy", 1,
			// 2);
	...
	private static void testWriteReviewEntry(DoubanService myService) {
		ReviewEntry reviewEntry;
		try {
			String movieId = "3036997"; // 绔嬫槬(And the Spring Comes)

			SubjectEntry se = myService.getMovie(movieId);
			Rating rate = new Rating();
			rate.setValue(4);
			String content = "绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬";
			reviewEntry = myService.createReview(se, new PlainTextConstruct(
					"绔嬫槬"), new PlainTextConstruct(content), rate);
	...
	private static void testWriteNoteEntry(DoubanService myService) {
		...
		try {
			String content = "绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬绔嬫槬";
			noteEntry = myService.createNote(new PlainTextConstruct("绔嬫槬"),
					new PlainTextConstruct(content), "public", "yes");

			printNoteEntry(noteEntry);
			String content2 = "绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬绔嬬";
			myService.updateNote(noteEntry, new PlainTextConstruct("绔嬬"),
