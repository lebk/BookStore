...
public class BookUIManager extends JPanel implements ListSelectionListener {
	private JTextArea rightContent;
	private JTree leftTree;
	private JSplitPane splitPane;


	public BookUIManager(File dir) {
	...
	protected static ImageIcon createImageIcon(String path) {
		java.net.URL imgURL = BookUIManager.class.getResource(path);
		if (imgURL != null) {
	...
	public static void createAndShowGUI(File dir) {
		...
		BookUIManager splitPaneDemo = new BookUIManager(dir);
